...
- generatedAt: `2026-04-27T06:15:54.750Z`
- total scenarios: 1
- passed scenarios: 1
- failed scenarios: 0
- init strategy: `team-default`
- command set: `init`, `sync`, `doctor`
...
- scenarios with pending evolution proposal reviews: 0
- accepted evolution proposals: 0
- scenarios with accepted evolution proposals: 0
...
- doctor: `ok`
- artifacts: `ok`
- selected presets: `enterprise-standard`
- selected tools: `claude-code`, `codex`, `cursor`, `trae`
- project profile decision: `auto-recommended`
- project profile review status: `not-scheduled`
- selected project profile: none
- recommended project profile: none
- overdue governance reviews: 0
- due today governance reviews: 0
- pending conversation reviews: 0
- warning-level conversation records: 0
