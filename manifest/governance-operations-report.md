...
- generatedAt: `2026-04-29T09:35:30.937Z`
...
- [automation] Release automation summarized 11 changed file(s), 1 affected domain(s), and recommended a minor release. (`2026-04-29T09:35:30.873Z`)
- [version-record] Version record last updated for @power/power-ai-skills@1.4.7. (`2026-04-29T09:35:30.873Z`)
- [upgrade-advice] Upgrade advice prepared 9 consumer command(s), 4 maintainer command(s), and 9 manual check(s). (`2026-04-29T09:35:30.871Z`)
- [promotion-trace] Promotion trace matched 1 relation(s) from 2 tracked relation(s). (`2026-04-29T09:35:30.800Z`)
- [release-gates] Release gates finished with status pass (0 blocking, 0 warning). (`2026-04-27T08:44:41.075Z`)
- [consumer-compatibility] Consumer compatibility matrix covered 1 scenario(s) with 0 failure(s). (`2026-04-27T08:44:40.929Z`)
