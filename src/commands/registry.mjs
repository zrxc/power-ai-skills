...
const commandDefinitions = [
  ...
  { name: "authorize-release-unattended-governance", scope: "project", method: "authorizeReleaseUnattendedGovernanceCommand", projectRootStrategy: PROJECT_ROOT_STRATEGIES.CWD },
  { name: "plan-release-unattended-governance", scope: "project", method: "planReleaseUnattendedGovernanceCommand", projectRootStrategy: PROJECT_ROOT_STRATEGIES.CWD },
